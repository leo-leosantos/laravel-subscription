                    ...
                    <div class="card card--col" id="Pro">
                        <div class="card__header">
                            <div class="flex items-center justify-between">
                                <h3 class="card__title"><?php echo e($plan->name); ?></h3><template><span class="badge"
                                    ></span></template>
                                            <?php if($plan->recomended): ?>
                            ...
                            <div class="card__price"><span class="price-currency mr-2"
                                    >R$</span> <span class="price-value"
                                    ><?php echo e($plan->price_br); ?></span> <span
                                    class="price-period"><span class="px-1">/</span><span>Mês</span></span></div>
                        </div>
                        <div class="card__features"><template>
                                ...
                                <p class="feature"><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor"
                                    ...
                                    </svg> <span><?php echo e($feature->name); ?></span></p>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>


                        </div>
                        <div class="card__footer text-center my-4"><a href="<?php echo e(route('choice.plan', $plan->url)); ?>"
...
<?php /**PATH /var/www/laravel-subscription/resources/views/home/_partials/plans.blade.php ENDPATH**/ ?>