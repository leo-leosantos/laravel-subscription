                        ...
                        <tr>
                            <td colspan="<?php echo e($invoice->hasTax() ? 3 : 2); ?>" style="text-align: right;">
                                <?php if($invoice->discountIsPercentage()): ?>
                                    <?php echo e($invoice->couponName()); ?> (<?php echo e($invoice->percentOff()); ?>% Off)
                                <?php else: ?>
                                    <?php echo e($invoice->couponName()); ?> (<?php echo e($invoice->amountOff()); ?> Off)
                                <?php endif; ?>
                            </td>
...
<?php /**PATH /var/www/laravel-subscription/vendor/laravel/cashier/src/../resources/views/receipt.blade.php ENDPATH**/ ?>