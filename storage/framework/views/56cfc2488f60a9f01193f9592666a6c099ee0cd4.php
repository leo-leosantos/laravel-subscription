    ...
    <div class="c-container relative">
        <div class="flex flex-col lg:flex-row flex-wrap items-center md:py-2 lg-py-0">
            <div class="w-full md:w-1/5"><img
                    ...
                    src="<?php echo e(asset('images/content/larachat.webp')); ?>" width="400" /></div>
...
<?php /**PATH /var/www/laravel-subscription/resources/views/home/_partials/header.blade.php ENDPATH**/ ?>